...
{
    [Header("Ice Giant Advanced Settings")]
    ...
    public override void Disable()
    {
        ...
        {
            enemy.ClearEffect(SpecialEffect.IceGiantAdvanced);
    ...
    private void SubscribeOrbiter(Orbiter orbiter)
    {
        ...
        orbiter.SetEffect(SpecialEffect.IceGiantAdvanced);
    }
    ...
    private void OnOrbiterHit(EnemyBase enemy)
    {
        ...
        enemy.SetEffect(SpecialEffect.IceGiantAdvanced);
    ...
    public override void OnUpdate()
    {
        ...
        foreach (var kvp in _slowedEnemies)
        {
            ...
            if (newTime <= 0f)
            {
                kvp.Key.ClearEffect(SpecialEffect.IceGiantAdvanced);
