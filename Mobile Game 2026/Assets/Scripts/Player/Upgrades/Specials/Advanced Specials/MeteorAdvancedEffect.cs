...
{
    [Header("Meteor Advanced Settings")]
    ...
    public override void Disable()
    {
        ...
        {
            enemy.ClearEffect(SpecialEffect.MeteorAdvanced);
    ...
    private void SubscribeOrbiter(Orbiter orbiter)
    {
        ...
        orbiter.SetEffect(SpecialEffect.MeteorAdvanced);
    }
    ...
    private void OnOrbiterHit(EnemyBase enemy)
    {
        ...
        enemy.SetEffect(SpecialEffect.MeteorAdvanced);
    }
    ...
    public override void OnUpdate()
    {
        ...
        foreach (var kvp in _enemiesOnFire)
        {
            ...
            if (newTime <= 0f)
            {
                kvp.Key.ClearEffect(SpecialEffect.MeteorAdvanced);
